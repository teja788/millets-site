...
import { fermentedProducts } from '@/data/fermentation';

export const metadata: Metadata = {
  title: 'Fermented Millet Foods | Millets Guide',
  description:
    ...
    <main>
      ...
      <div className="content-wrapper py-8">
        ...
        <h1 className="font-heading text-4xl md:text-5xl font-bold text-earth-100 mb-6">
          Fermented Millet Foods &amp; Beverages
        </h1>

        {/* Intro */}
        <div className="max-w-3xl space-y-4 text-earth-200 leading-relaxed mb-8">
          <p>
        ...
        {/* Key Stat Highlight */}
        <div className="bg-earth-800 rounded-xl p-6 max-w-3xl mb-12 border-l-4 border-earth-500">
          <p className="text-earth-100 font-heading text-lg font-bold mb-1">
            Key Finding
          </p>
          <p className="text-earth-200 leading-relaxed">
            <strong className="text-earth-100">24-hour fermentation reduces phytic acid by ~52%</strong>,
              ...
              <CardBody>
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-1">
                    <FlaskConical className="w-4 h-4 text-earth-400 flex-shrink-0" />
                ...
                <div className="flex items-center gap-2 mb-4">
                  <Clock className="w-4 h-4 text-earth-400 flex-shrink-0" />
                  <span className="text-sm text-earth-300">
                    <strong className="text-earth-100">Duration:</strong>{' '}
                    {product.duration}
                  </span>
                </div>
