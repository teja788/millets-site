...
const typeConfig: Record<SearchableItem['type'], { icon: React.ReactNode; color: string }> = {
  millet: {
...
function SearchResults() {
  ...
  const groupLabels: Record<SearchableItem['type'], string> = {
    ...
    recipe: t.search.typeLabels.recipe,
    faq: t.search.typeLabels.faq,
    page: t.search.typeLabels.page,
    tool: t.search.typeLabels.tool,
    tradition: t.search.typeLabels.tradition,
    region: t.search.typeLabels.region,
  };
                    ...
                    <section key={type}>
                      ...
                      <div className="space-y-3">
                        {group.map((result) => (
                          <Link
                            key={result.item.id}
                            href={localePath(locale, result.item.url)}
