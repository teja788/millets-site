...
export const fr: TranslationKeys = {
  ...
  cookieConsent: {
    message: 'Ce site utilise des cookies à des fins d\'analyse et de publicité personnalisée. En cliquant sur « Accepter », vous consentez à l\'utilisation de tous les cookies.',
    accept: 'Accepter',
    decline: 'Refuser',
    learnMore: 'En savoir plus',
  },
  ...
  home: {
    ...
    whatAreMilletsP3: 'L\'Inde est le premier producteur mondial de millets, et 2023 a été déclarée Année internationale du millet par les Nations Unies, à l\'initiative de l\'Inde et avec le soutien de plus de 70 pays. Cette attention mondiale renouvelée s\'appuie sur une histoire qui remonte bien avant l\'agriculture moderne : des sites archéologiques du nord de la Chine conservent des grains de millet des oiseaux et de millet commun datant d\'environ 8700 av. J.-C., tandis que le mil à chandelle a été domestiqué indépendamment dans le Sahel ouest-africain vers 4500 av. J.-C. et a atteint le sous-continent indien environ deux millénaires plus tard.',
    whatAreMilletsP4: 'Les millets suscitent un intérêt renouvelé en tant que cultures résilientes au changement climatique. Le mil à chandelle peut produire une récolte avec seulement 350 à 500 mm de précipitations saisonnières et mûrit en 65 à 85 jours, tandis que le millet des oiseaux, le millet panic et le kodo se contentent de budgets d\'eau tout aussi modestes. L\'éleusine (ragi) fournit quant à elle environ 344 mg de calcium pour 100 grammes — le taux le plus élevé parmi les céréales courantes, et plusieurs fois supérieur à celui du riz blanchi. Les textes médicaux indiens classiques tels que Charaka Samhita, Sushruta Samhita et Bhavaprakasha Nighantu ont classé ces grains dans des catégories thérapeutiques spécifiques — les plaçant généralement parmi les grains laghu (légers à digérer) et kashaya (astringents) — bien avant que la nutrition moderne ne les étudie.',
    whatAreMilletsP5: 'Ce site traite neuf millets en profondeur : leur nutrition (à partir des tables de composition des aliments ICMR-NIN et des bases USDA), recettes traditionnelles et contemporaines, propriétés ayurvédiques, pratiques culturales et traditions culinaires régionales en Inde et à l\'étranger. Chaque affirmation est, autant que possible, attribuée à une source nommée, et nous distinguons les connaissances bien établies des recherches préliminaires. Notre objectif n\'est pas de vendre les millets comme un super-aliment, mais de vous aider à comprendre ce qu\'ils sont, en quoi les différentes espèces diffèrent, et comment les utiliser concrètement en cuisine.',
  ...
  privacyPolicy: {
    ...
    advertisingText: 'Ce site affiche des publicités diffusées par Google AdSense. Google et ses partenaires publicitaires peuvent utiliser des cookies pour diffuser des annonces personnalisées en fonction de votre activité de navigation. Vous pouvez désactiver la publicité personnalisée en visitant les paramètres de publicité de Google.',
  ...
  disclaimerPage: {
    ...
    noEndorsementTitle: 'Aucune approbation professionnelle',
    noEndorsementText: 'Rien sur ce site ne constitue une approbation par un organisme médical, nutritionnel, agricole ou gouvernemental. Les références à l\'ICMR-NIN, l\'USDA, la FAO et d\'autres institutions sont fournies uniquement comme citations des données sous-jacentes. Ces organisations n\'ont pas examiné, approuvé ou validé le contenu ou les recommandations présentés sur Simply Millets. Toute mention de produit, marque ou ressource tierce est à titre informatif et n\'implique aucun parrainage.',
    resultsVaryTitle: 'Les résultats individuels peuvent varier',
    resultsVaryText: 'Les bénéfices nutritionnels, les effets ayurvédiques, les résultats culinaires et les réponses sanitaires décrits sur ce site sont des généralisations tirées de recherches publiées et de sources traditionnelles. Votre réponse personnelle à un aliment, y compris les millets, dépend de la génétique, du microbiote intestinal, des conditions de santé existantes, des médicaments, du niveau d\'activité, du mode de préparation et de la variété particulière du grain.',
    consultProfessionalTitle: 'Consultez un professionnel qualifié',
    consultProfessionalText: 'Avant d\'apporter des modifications importantes à votre alimentation — en particulier si vous êtes diabétique, souffrez de problèmes thyroïdiens, rénaux, de la maladie cœliaque, de sensibilité au gluten, de grossesse, ou si vous nourrissez des nourrissons ou de jeunes enfants — consultez une diététicienne, votre médecin ou un praticien ayurvédique qualifié. N\'utilisez pas ce site comme substitut à des conseils médicaux ou nutritionnels personnalisés.',
    affiliateDisclosureTitle: 'Divulgation commerciale et affiliation',
    affiliateDisclosureText: 'Simply Millets ne participe actuellement à aucun programme d\'affiliation pour les produits ou ingrédients mentionnés. Si cela change, les pages concernées seront clairement étiquetées. Nous affichons de la publicité via Google AdSense ; ces publicités sont diffusées par des tiers et ne constituent pas une approbation de Simply Millets.',
  },
  ...
  aboutPage: {
    ...
    introP1: 'Ce site existe pour fournir des informations complètes et accessibles sur les millets. À une époque de tendances santé et de marketing autour des super-aliments, il existe un réel besoin d\'une ressource unique et bien organisée qui présente les informations sur les millets fondées sur des preuves plutôt que sur le battage médiatique.',
    introP2: 'Nous couvrons la nutrition (à partir des bases ICMR-NIN et USDA), les recettes traditionnelles, les propriétés ayurvédiques (référencées dans des textes classiques tels que Charaka Samhita et Bhavaprakasha Nighantu), les pratiques culturales et le contexte historique. Comprendre les millets dans leur ensemble — pas seulement comme un aliment santé, mais comme un trésor culturel, écologique et agricole — est essentiel à leur revitalisation.',
    introP3: 'Les données nutritionnelles suivent les tables de composition des aliments indiens de l\'ICMR-NIN (2017) comme référence principale. Les informations ayurvédiques sont attribuées à des textes classiques spécifiques. Nous distinguons la science bien établie des preuves préliminaires.',
    keyReferencesHeading: 'Références clés',
    readyToExplore: 'Prêt à explorer ?',
    browseAllMillets: 'Parcourir tous les millets',
    nutritionComparison: 'Comparaison nutritionnelle',
    recipes: 'Recettes',
    history: 'Histoire',
    privacyPolicy: 'Politique de confidentialité',
    contact: 'Contact',
