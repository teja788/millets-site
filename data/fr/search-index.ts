...
export const searchIndex: SearchableItem[] = [
  ...
  { id: 'glossary', title: 'Glossaire des millets', description: 'Noms des millets dans 12 langues indiennes', type: 'page' as const, url: '/fr/glossary', tags: ['glossaire', 'langues'] },
  ...
  { id: 'regional-traditions', title: 'Traditions régionales des millets', description: 'Découvrez comment les différents États indiens utilisent les millets', type: 'page' as const, url: '/fr/regional-traditions', tags: ['régional', 'traditions'] },
  ...
  { id: 'ancient-references', title: 'Références anciennes aux millets', description: 'Preuves littéraires et archéologiques des millets dans les textes anciens', type: 'page' as const, url: '/fr/ancient-references', tags: ['ancien', 'textes', 'vedas'] },
