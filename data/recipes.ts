...
const recipeCatalog: Recipe[] = [
...

  {
    ...
    ingredients: [
      { item: 'Ragi (finger millet) flour', quantity: '1/2 cup (60 g)' },
      { item: 'Water', quantity: '4 cups' },
      { item: 'Buttermilk (or thin curd)', quantity: '1.5 cups' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
      { item: 'Curry leaves', quantity: '1 sprig (for serving)', isOptional: true },
      { item: 'Green chili, finely chopped', quantity: '1 (for serving)', isOptional: true },
    ],
    instructions: [
...

  {
    ...
    title: 'Foxtail Millet Ambali (Korralu / Thinai Ambali)',
    millets: ['foxtail-millet'],
    category: 'drink',
    cuisine: 'South Indian',
    ...
    ingredients: [
      { item: 'Foxtail millet (korralu)', quantity: '1/2 cup (90 g)' },
      { item: 'Water', quantity: '4 cups, plus extra to loosen' },
      { item: 'Buttermilk (or thin curd)', quantity: '1 cup' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
      { item: 'Curry leaves', quantity: '1 sprig (for serving)', isOptional: true },
      { item: 'Green chili, finely chopped', quantity: '1 (for serving)', isOptional: true },
...

  {
    ...
    title: 'Little Millet Ambali (Samalu / Saamai Ambali)',
    millets: ['little-millet'],
    category: 'drink',
    cuisine: 'South Indian',
    prepTime: '30 min soak + overnight ferment',
    ...
    ingredients: [
      { item: 'Little millet (samalu)', quantity: '1/2 cup (95 g)' },
      { item: 'Water', quantity: '4 cups, plus extra to loosen' },
      { item: 'Buttermilk (or thin curd)', quantity: '1 cup' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
...

  {
    ...
    title: 'Kodo Millet Ambali (Arikelu / Varagu Ambali)',
    millets: ['kodo-millet'],
    category: 'drink',
    cuisine: 'South Indian',
    ...
    ingredients: [
      { item: 'Kodo millet (arikelu)', quantity: '1/2 cup (95 g)' },
      { item: 'Water', quantity: '5 cups, plus extra to loosen' },
      { item: 'Buttermilk (or thin curd)', quantity: '1 cup' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
      { item: 'Curry leaves', quantity: '1 sprig (for serving)', isOptional: true },
...

  {
    ...
    title: 'Barnyard Millet Ambali (Udalu / Kuthiraivali Ambali)',
    millets: ['barnyard-millet'],
    category: 'drink',
    cuisine: 'South Indian',
    ...
    ingredients: [
      { item: 'Barnyard millet (udalu)', quantity: '1/2 cup (90 g)' },
      { item: 'Water', quantity: '4 cups, plus extra to loosen' },
      { item: 'Buttermilk (or thin curd)', quantity: '1 cup' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
...

  {
    ...
    title: 'Browntop Millet Ambali (Andu Korralu / Korale Ambali)',
    ...
    ingredients: [
      { item: 'Browntop millet (andu korralu)', quantity: '1/2 cup (95 g)' },
      { item: 'Water', quantity: '5 cups, plus extra to loosen' },
      { item: 'Buttermilk (or thin curd)', quantity: '1 cup' },
      { item: 'Salt', quantity: 'to taste (add at serving)' },
      { item: 'Small onion, finely chopped', quantity: '1 (for serving)', isOptional: true },
