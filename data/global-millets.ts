    ...
    iconicFoods: [
      {
        ...
        millet: 'Teff',
        description:
          'A large, spongy, sourdough-risen flatbread with a distinctive tangy flavour produced by wild-yeast fermentation over 2-3 days. It is both plate and utensil. Diners tear pieces to scoop up stews (wot). Pure teff injera is prized, though blends with wheat or sorghum are common in rural areas.',
      },
      {
        name: 'Tella',
        country: 'Ethiopia',
  ...
  // ─── 7. SOUTHERN AFRICA ───────────────────────────────────────────
  {
    ...
    iconicFoods: [
      ...
      },
      {
        ...
        description:
          'A non-alcoholic or very mildly fermented pearl millet drink traditional to the Owambo people of northern Namibia. Made from pounded mahangu (pearl millet) mixed with water and allowed to ferment briefly, oshikundu is a daily refreshment consumed by people of all ages. It is nutritionally rich and acts as both food and drink in the semi-arid Owambo homeland.',
      },
    ],
    historicalHighlights: [
      {
